...
public class ScamInsertTester {
	...
	public static void main(String[] args) {
		...
		//	String scam9 = "Insert into scam values(9,'PNB scam','Abdcanded Scam','2016-8-12','VijayMalya',900000,'Banglore','Anscond by taking loan')";
			...
			String scam13 = "insert into scam values(13,'ILFS','corporate fraud',2017-10-2,'IL&FS',91000000,'ILFS fraud was the largest corporate fraud in India and triggered a showdown in the economy, as the company was a key vehicle for infrastructure development of the country.') ";
			String scam14= "insert into scam values(14,'PMCBank','perpetuatedfraud',2011-2-5,'PravinRaut',7000000,'Around 70 percent of its total loan book of Rs 8,383 crore as on March 31, 2019, had been taken by real estate firm HDIL.') ";
			...
			String scam16="insert into scam values(16,'2G Spectrum scam','telephone',2012-12-05,'CAG',176000,' 2G spectrum subscriptions, and at the centre of this controversy was the former Telecom minister')";
			String scam17="insert into scam values(17,'Commonwealthscam','GameScam',2010-12-5,'Suresh Kalmadi',70000,' The whole event was marred with accusations of criminal conspiracy, cheating and forgery and the chairman of Common Wealth Games 2010 Suresh Kalmadi was accused of corruption and malpractices')";
			String scam18 = "insert into scam values(18,'PNB scam','Bank',2016-14-2,'King of good times Vijay Mallya',9000,'Karnataka','rs 9000cr which he had taken as a loan to keep his now defunct Kingfisher airlines from failing.')";
			String scam19="insert into values(19,'BOFORSscanda','weapons-contract',1986-2-15,' Swedish',64000000,'India','weapons-contract scandal that took place between India and Sweden during the 1980s and 90s. In 1986')";
			String scam20="insert into values(20,'AgustaWestland','chopper scam',2010-12-1,'UPA', 3600,'India','this case is about a 2010 deal signed between the UPA government and AgustaWestland for acquisition of 12 helicopters that were supposed to be used by the President of India')";
